...
// an etch341 docs page is shared.
//
...
// landing page, PortFinder + Baudrun docs heroes):
//   - Navy radial gradient ground (#2e4368 → #162237 → #04080e)
//   - Amber glow at the lower-left, drifting up
//   - etch341 app icon (wireframe SOIC-8), drop-shadowed
//   - "etch341" set in a serif (Fraunces if available, Georgia
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
	...
	<g font-family="'Fraunces', Georgia, 'Times New Roman', serif" fill="#fafbfd">
		<text x="420" y="270" font-size="120" font-weight="600" letter-spacing="-3">etch341</text>
	</g>
	<g font-family="'IBM Plex Sans', system-ui, -apple-system, sans-serif" fill="#d3d8e1">
		<text x="420" y="335" font-size="30" font-weight="400">CH341A flash programmer — SPI NOR + I²C EEPROM.</text>
		<text x="420" y="385" font-size="26" font-weight="400" fill="#aab1c0">Detect · read · erase · write · verify. macOS · Windows · Linux.</text>
	</g>

	<!-- Footer URL, bottom-left -->
	<g font-family="'IBM Plex Mono', ui-monospace, monospace" fill="#6e7689">
		<text x="120" y="${H - 50}" font-size="22" letter-spacing="1">packetthrower.github.io/etch341</text>
	</g>
</svg>`;
